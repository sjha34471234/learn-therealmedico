...
//   - Google OAuth redirectTo must point to /auth/callback on this domain
//   - After sign in/up success, redirect via window.location.href not router.push
// ============================================================
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#050510', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
      ...
      <div style={{ position: 'relative', zIndex: 1, width: '100%', maxWidth: '380px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '16px', padding: '40px 28px' }}>
        ...
        {error && <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '12px', color: '#f87171', marginTop: '10px', textAlign: 'center', margin: '10px 0 0' }}>{error}</p>}
        {success && <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '12px', color: '#34d399', marginTop: '10px', textAlign: 'center', margin: '10px 0 0' }}>{success}</p>}
...
// REASON: More familiar flow for users. Magic link adds friction on mobile.
// --- END CHANGE LOG ---
